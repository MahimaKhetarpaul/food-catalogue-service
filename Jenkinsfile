  ...
  steps {
   ...
   stage('Check code coverage') {
      ...
      steps {
          ...
          sh 'docker build -t mahimakhetarpaul/food-catalogue-service:${VERSION} .'
          sh 'docker push mahimakhetarpaul/food-catalogue-service:${VERSION}'
      }
    }
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: mahimakhetarpaul\\/food-catalogue-service:${VERSION}/" aws/food-catalogue-manifest.yml
        '''
